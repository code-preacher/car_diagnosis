                                     ...
                                     <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">New battery is dead: </label>
                                            ...
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                    <label class="control-label">Shaking car components inside the car:</label>
                                            ...
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                    <label class="control-label">White exhaust smoke:</label>
                                            ...
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                    <label class="control-label">Squeals from under the bonnet:</label>
                                            ...
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                    <label class="control-label">Overheating of the engine:</label>
                                            ...
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                    <label class="control-label">Squeals while braking:</label>

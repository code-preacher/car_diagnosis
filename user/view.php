        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                       ...
                                       <div class="row p-t-20">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">New battery dead: </label>
                                        ...
                                        <div class="col-md-6">
                                          <div class="form-group">
                                            <label class="control-label">Experiencing Shaking car components inside the car:</label>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label class="control-label">Experiencing White exhaust smoke:</label>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label class="control-label">Steering wheel vibrating:</label>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="control-label">Experiencing Squeals from under the bonnet:</label>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="control-label">Experiencing Overheating of engine:</label>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="control-label">Car not starting:</label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label">Experiencing Squeals while braking:</label>

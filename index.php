...
<head>
    ...
    <title>CAR DIAGNOSITIC SYSTEM!</title>
                ...
                <div class="container">
                    <div class="navbar-header pull-left">
                        <a class="navbar-brand page-scroll" href="#page-top">
                            ...
                            <span class="brand-logo">CAR DIAGNOSITIC SYSTEM</span>
                        </a>
                    </div>
            ...
            <header id="intro-carousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInDown">Welcome to CAR DIAGNOSITIC SYSTEM! </h1>
                    ...
                    <div class="item">
                        ...
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInDown">Diagnise your car </span> </h1>
                ...
                <div class="mouse"></div>
                            ...
                            <div class="col-md-12 text-center">
                                &copy; 2021.CAR DIAGNOSITIC SYSTEM! All rights reserved.
                            </div><!-- /.col-md-12 -->
